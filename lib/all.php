...
$nama = nama();
        ...
        if(strpos($register, '"otp_token"')){
			...
			if(strpos($verif, '"access_token"')){
				...
				echo color("green","\n===========(REDEEM VOUCHER)===========");
				echo "\n".color("yellow","[!] Claim Voc Awas Tercyduk Ya Bosku :v");
				...
				if(strpos($code1, 'You can use this promo now...')){
					...
					echo "\n".color("yellow","[!] Claim Voc Tidak Semua KTP Work :V");
					echo "\n".color("yellow","[!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					goride:
					echo "\n".color("yellow","[!] Claim Voc Beli Napa Cok");
					echo "\n".color("yellow","[!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
					...
					echo "\n".color("yellow","[!] Claim Voc Dasar Miskin");
					echo "\n".color("yellow","[!] Please wait...");
					for($a=1;$a<=3;$a++){
						echo color("yellow",".");
						sleep(1);
